...
<html>
<head>
	<% if (session.getAttribute("admins")==null) response.sendRedirect("login.jsp");%>
    <!--
        ===
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="active"><a class="ajax-link" href="admin-list.jsp?adminname=${adminname}"><i class="glyphicon glyphicon-cog"></i><span> &ensp;管&ensp;理&ensp;员&ensp;信&ensp;息</span></a>
                        <li><a class="ajax-link" href="../maintain/mainlist?adminname=${adminname}"><i class="glyphicon glyphicon-wrench"></i><span> &ensp;报&ensp;修&ensp;管&ensp;理</span></a>
                        <li><a class="ajax-link" href="../notice/noticelist?adminname=${adminname}"><i class="glyphicon glyphicon-envelope"></i><span> &ensp;公&ensp;告&ensp;管&ensp;理</span></a>
                        <li><a class="ajax-link" href="../inspection/insectionlist?adminname=${adminname}"><i class="glyphicon glyphicon-info-sign"></i><span> &ensp;保&ensp;安&ensp;保&ensp;洁</span></a>
                        <li><a class="ajax-link" href="../custom/listall?adminname=${adminname}"><i class="glyphicon glyphicon-user"></i><span> &ensp;业&ensp;主&ensp;信&ensp;息</span></a>
                        <li><a class="ajax-link" href="../house/adminhouselist?adminname=${adminname}"><i class="glyphicon glyphicon-list-alt"></i><span> &ensp;房&ensp;产&ensp;信&ensp;息</span></a>
                        </li>
                    </ul>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form action="addsaveedit?${admins.id}" method="post" data-toggle="validator">
					...
					<div class="form-group">
						<div class="input-group col-md-1">
							...
							<input type="number" class="form-control" name="age" value="${admins.age}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-3">
							...
							<input type="text" class="form-control" name="tel" value="${admins.tel}"/>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-3">
							<%--@declare id="phone"--%><label class="control-label" for="phone">手机</label>
							<input type="text" class="form-control" name="phone" value="${admins.phone}"/>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-4">
							<%--@declare id="addr"--%><label class="control-label" for="addr">地址*</label>
							<input type="text" class="form-control" name="addr" value="${admins.addr}" required/>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					<div class="form-group">
						<div class="input-group col-md-4">
							...
							<input type="text" class="form-control" name="memo" value="${admins.memo}"/>
						</div>
					</div>
