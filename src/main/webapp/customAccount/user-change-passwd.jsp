                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        <li class="nav-header">功能</li>
							...
							<li class="active"><a class="ajax-link" href="change?accountid=${customAccount.accountid}"><i class="glyphicon glyphicon-info-sign"></i><span> &ensp;修&ensp;改&ensp;密&ensp;码</span></a>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                <form role="form" data-toggle="validator" action="changepwd?accountid=${customAccount.accountid}" method="post">
