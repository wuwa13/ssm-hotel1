...
<html>
<head>
	<% if (session.getAttribute("maintain")==null) response.sendRedirect("login.jsp");%>
    <!--
        ===
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="../notice/?adminname=${adminname}"><i class="glyphicon glyphicon-envelope"></i><span> &ensp;公&ensp;告&ensp;管&ensp;理</span></a>
	...
	<div class="box col-md-12">
		<div class="box-inner">
			...
			<div class="box-content">
                 <form role="form" data-toggle="validator" action="finshedit?id=${maintain.id}" method="post">
				 <fieldset>
					...
					<div class="form-group">
						...
						<input type="hidden" id="dtpinput2" value="" /><br/>
					</div>
					<div class="form-group">
